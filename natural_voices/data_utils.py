...
from natural_voices.mel_processing import spectrogram_torch
from natural_voices.utils import load_wav_to_torch, load_filepaths_and_text
from natural_voices.text import text_to_sequence, cleaned_text_to_sequence
import tempfile
...
class TextMapper(object):
    ...
    def get_text(self, text):
        ...
        text_norm = natural_voices.commons.intersperse(text_norm, 0)
...
class TextAudioLoader(torch.utils.data.Dataset):
    ...
    def __init__(self, audiopaths_and_text, hparams):
        ...
        vocab_file = f"/home/alberto/vits-finetune/natural_voices/vocabs/{hparams.lang}.txt"
        lang = hparams.lang
